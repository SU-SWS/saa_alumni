...
const PerkCardView = ({
  ...
  let headlineIconClasses =
    "group-hocus:su-translate-x-02em su-ml-03em su--mt-03em su-w-1em";
  ...
  if (externalUrl) {
    ...
    headlineIconClasses =
      "su-transform su-rotate-45 group-hocus:su-rotate-45 group-hocus:su-translate-x-01em group-hocus:su--translate-y-01em su-ml-02em su--mt-01em su-w-1em";
  }
