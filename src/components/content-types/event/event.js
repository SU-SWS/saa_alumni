    ...
    <SbEditable content={blok}>
      ...
      >
        ...
        <SbLink
          link={eventLink}
          classes={dcnb(
            'su-stretched-link su-group su-z-20 su-rs-mt-0 su-mb-08em su-no-underline hocus:su-underline su-underline-offset !su-underline-thick !su-decoration-digital-red-xlight',
            headlineSize,
            headlinePadding,
            headlineColor
          )}
