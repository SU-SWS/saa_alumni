...
export const label =
  'su-relative su-text-16 xl:su-text-21 su-p-04em su-flex su-flex-row su-items-center su-text-white su-bg-black-true focus-within:su-bg-transparent group-hover:su-bg-transparent su-cursor-pointer';
