    ...
    <SbEditable content={blok}>
      ...
      <nav className="main-nav-mobile lg:su-hidden" aria-label="Main Menu">
        <Button
          variant="unset"
          size="minimal"
          className="su-flex su-flex-col su-w-40 su-items-center su-rs-ml-0 su-text-14 su-font-semibold lg:su-hidden"
          onClick={toggleMenu}
        ...
        <ul
          className={`${menuOpened ? "" : "su-hidden "}su-absolute su-right-0 su-top-[107px] md:su-top-[119px] su-cc su-w-full su-bg-cardinal-red-xdark su-border-t su-border-solid su-border-digital-red-xlight su-flex su-flex-col su-list-unstyled children:su-mb-0`}
