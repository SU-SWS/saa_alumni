...
const buttonMobile =
  'su-flex su-items-center su-font-semibold su-w-full hocus:su-shadow-none hocus:su-underline su-py-20 su-pl-20 su-pr-80 su-text-20';
const buttonDesktop =
...
const topLinkMobile =
  'su-flex su-items-center su-font-semibold hocus:su-underline hocus:su-text-white hocus:su-bg-black-90 su-p-20 su-text-20';
