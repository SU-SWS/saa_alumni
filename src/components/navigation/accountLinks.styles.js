...
export const initialCircle =
  'su-w-full su-h-full su-transition su-leading su-text-center su-text-white su-border-2 su-border-digital-red-xlight su-rounded-full lg:group-hocus:su-bg-cardinal-red-xxdark xl:group-hocus:su-bg-cardinal-red-dark su-uppercase';
