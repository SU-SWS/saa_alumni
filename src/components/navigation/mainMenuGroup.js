...
const MainMenuGroup = ({ blok: { parentText, menuItems } }) => (
  <Popover as="li" className="focus-within:su-bg-cardinal-red">
    <Popover.Button className="su-font-bold su-bg-transparent su-pb-[4.7rem] su-border-solid su-border-b-[5px] su-border-transparent hover:su-border-digital-red-xlight hover:su-text-digital-red-xlight hocus:su-no-underline focus:su-bg-cardinal-red focus:su-text-white hover:su-bg-transparent focus:su-outline-none">
      {parentText}
    </Popover.Button>
    <Transition
