...
const MainMenuGroup = ({
  ...
  const buttonMobile =
    "su-flex su-items-center su-w-full hocus:su-bg-cardinal-red-xxdark hocus:su-shadow-none su-py-20";
  const buttonDesktop =
    "lg:su-items-end lg:su-px-15 xl:su-pt-20 lg:su-pb-18 xl:su-pb-[3rem] lg:hocus:su-bg-transparent lg:su-whitespace-pre lg:hocus:su-text-digital-red-light lg:hocus:su-no-underline lg:su-border-b-[5px] lg:su-border-solid lg:su-border-transparent lg:hocus:su-border-digital-red-xlight";
      ...
      {({ open }) => (
        <>
          <Popover.Button
            className={`${
              open
                ? "!su-text-white !su-bg-cardinal-red-xxdark lg:!su-bg-cardinal-red-xdark !su-border-cardinal-red-xdark"
                : ""
            ...
            <Popover.Panel
              ...
              className={`su-list-unstyled ${
                ...
                open
                  ...
                  : ""
              } lg:su-shadow-md lg:su-w-[29rem] su-px-20 su-py-10 su-relative lg:su-absolute su-bg-cardinal-red-xdark children:su-mb-0`}
            >
