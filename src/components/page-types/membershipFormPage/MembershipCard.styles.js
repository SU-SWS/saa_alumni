...
export const membershipCardWrapper =
  'su-basefont-23 su-rs-p-3 su-stretch-link su-w-full su-transition-all su-rounded su-border su-border-3 su-border-white hocus:su-gradient-border hocus:su-border-to-rt-palo-verde-dark-to-saa-electric-blue focus:su-outline-2 focus:su-outline-offset-2 ';
