...
export const membershipCardLink = (disabled, selected) =>
  dcnb(
    ...
    {
      'su-text-white su-bg-gradient-to-tr su-from-palo-verde-dark su-to-saa-electric-blue su-shadow-md hocus:su-text-white':
        selected,
    },
    disabled
...
export const membershipCardWrapper = (disabled, selected) =>
  dcnb(
    'su-basefont-23 su-p-36 su-stretch-link su-w-full su-transition-all su-border-3 su-border-white',
    disabled
      ? 'su-pointer-events-none'
      : 'hocus:su-gradient-border hocus:su-border-to-rt-palo-verde-dark-to-saa-electric-blue',
    {
      'su-bg-black': selected,
    }
  );
