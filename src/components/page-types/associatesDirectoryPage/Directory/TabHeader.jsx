...
const TabHeader = ({ group, activeTab, handleTabClick, handleKeyPress }) => {
  ...
  return (
    <a
      ...
      } su-py-[8px] su-px-[15px] su-text-white hover:su-text-white hover:su-no-underline focus:su-text-white focus:su-no-underline su-border su-border-solid su-border-1 su-border-black-30/40`}
      href={`#${group}`}
