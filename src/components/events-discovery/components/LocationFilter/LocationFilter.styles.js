...
export const input =
  'focus:!su-ring-0 !su-pl-8 xl:!su-pl-19 !su-pr-20 xl:!su-pr-40 !su-ml-36 !su-pt-19 !su-pb-20 !su-leading-display focus:!su-border-0 selection:su-bg-digital-red-20 !su-caret-digital-red !su-transition-colors placeholder:!su-opacity-100 placeholder:!su-text-black-70 placeholder:xl:!su-text-transparent';
...
export const clearIcon =
  '!su-text-21 !su-text-black-70 hocus:!su-text-digital-red !su-absolute !su-right-20 !su--top-4';
export const pinIcon =
  'su-text-black-70 su-absolute su-top-18 su-left-8 xl:su-left-16 su-w-24';
...
export const toggleButton =
  'su-w-full su-transition-colors !su-leading-none !su-px-2 !su-pt-10 !su-pb-11 !su-border-digital-red-light hover:!su-bg-digital-red-20 focus-visible:!su-bg-digital-red-20 !su-text-digital-red hover:!su-text-digital-red-dark focus-visible:!su-text-digital-red-dark hocus:!su-underline aria-pressed:!su-bg-digital-red aria-pressed:!su-text-white !su-text-16 !su-font-sans !su-normal-case disabled:!su-su-bg-black-10 disabled:!su-su-border-black-40 disabled:!su-text-black-70 disabled:aria-pressed:!su-bg-black-70';
