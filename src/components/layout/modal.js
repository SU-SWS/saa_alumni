...
const Modal = ({ children, isOpen, onClose, ariaLabel, initialFocus }) => {
  ...
  return (
    <div
      className={`su-modal
      su-fixed su-w-full su-h-full su-top-0 su-left-0 su-items-center su-bg-saa-black su-justify-center su-z-50
    ...
    `}
      ...
      tabIndex="-1"
    >
      <div className="su-absolute su-w-full su-h-full su-opacity-95 su-pt-70 su-overflow-auto">
        <Container>
