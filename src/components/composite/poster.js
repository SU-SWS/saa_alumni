...
const Poster = ({
  ...
  if (layout === 'left') {
    ...
    imageWrapper =
      'su-flex-shrink-0 su-rs-mb-2 su-mx-auto md:su-rs-mr-4 md:su-mb-0 md:su-ml-0 print:su-hidden';
    ...
    imageWrapper = 'su-rs-mb-2 print:su-hidden';
  }
  ...
  return (
    <SbEditable content={blok}>
      <Container
        className={dcnb(
          'poster print:su-bg-white print:!su-bg-none print:su-text-black su-basefont-23 su-rs-pt-5 su-rs-pb-6 su-bg-cover su-bg-no-repeat',
          wrapperClasses,
          bgCrop,
          colorTheme
        )}
