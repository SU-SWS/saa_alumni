...
const SearchButton = (props) => (
  <Button
    ...
    className={{
      ...
      "search-button su-pl-16 su-pr-13 su-rounded-full su-text-18 su-leading-none su-border-2 su-border-solid su-border-digital-red-xlight su-transition-colors hocus:su-bg-cardinal-red-xdark": true,
    }}
    variant="unset"
    size="minimal"
    {...props}
