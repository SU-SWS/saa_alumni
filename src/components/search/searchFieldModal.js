...
const SearchFieldModal = React.forwardRef((props, ref) => {
  ...
  const inputClasses = `su-bg-transparent su-text-black-10 su-text-black-40::placeholder su-w-full su-flex-1
  su-rs-px-1 su-py-10 su-text-[44px] focus:su-outline-none`;
