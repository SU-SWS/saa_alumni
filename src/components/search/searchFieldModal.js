...
const SearchFieldModal = React.forwardRef((props, ref) => {
  ...
  const submitBtnClasses = `su-flex su-items-center su-justify-center su-min-w-[4rem] su-w-40 su-h-40 md:su-min-w-[7rem] md:su-w-70 md:su-h-70 su-rounded-full su-transition-colors
