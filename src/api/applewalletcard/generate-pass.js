...
export async function handler(event, context) {
    ...
    try {
        ...
        const passModelDirectory = path.join(__dirname, '..', '..', 'src', 'saacard.pass');

        const wwdr = fs.readFileSync(path.join(__dirname, '..', '..', 'src', 'certs', 'wwdr.pem'));
        const signerCert = fs.readFileSync(path.join(__dirname, '..', '..', 'src', 'certs', 'SignerCert.pem'));
        const signerKey = fs.readFileSync(path.join(__dirname, '..', '..', 'src', 'certs', 'SignerKey.pem'));
